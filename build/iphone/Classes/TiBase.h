...
// in simulator we redefine to format for Settimani Developer console
...
{\
	NSString * exceptionName = [@"org.settimani." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.settimani";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISettimaniNativeItemNone = -1, 
	UISettimaniNativeItemSpinner = -2,
	UISettimaniNativeItemProgressBar = -3,
	
	UISettimaniNativeItemSlider = -4,
	UISettimaniNativeItemSwitch = -5,
	UISettimaniNativeItemMultiButton = -6,
	UISettimaniNativeItemSegmented = -7,
	
	UISettimaniNativeItemTextView = -8,
	UISettimaniNativeItemTextField = -9,
	UISettimaniNativeItemSearchBar = -10,
	
	UISettimaniNativeItemPicker = -11,
	UISettimaniNativeItemDatePicker = -12,
	
	UISettimaniNativeItemInfoLight = -13,
	UISettimaniNativeItemInfoDark = -14,
	
	UISettimaniNativeItemDisclosure = -15,
	
	UISettimaniNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Settimani instances of
