 ...
 * Copyright (c) 2009-2011 by Settimani, Inc. All Rights Reserved.
...
//@interface SettimaniObject : NSObject
//@end

@interface SettimaniObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SettimaniObject class]])
		{
			for (NSString *key in [[(SettimaniObject*)o modules] allKeys])
			{
