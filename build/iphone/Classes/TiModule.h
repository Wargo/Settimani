...
/**
 The base class for all Settimani modules
 */
...
/**
 Settimani Platform calls this method on startup.
 */
-(void)startup;

/**
 Settimani Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Settimani Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Settimani Platform calls this method on resume.
 @param sender The sender of the event.
 */
