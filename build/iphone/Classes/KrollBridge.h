...
@interface SettimaniObject : KrollCoverageObject {
#else
@interface SettimaniObject : KrollObject {
#endif
@private
...
extern NSString * Settimani$ModuleRequireFormat;
